...
app.get('/trackings/:tagId/about', function (req, res) { return res.send(req.params.tagId); });
app.get('/trackings/:tagId/locations', function (req, res) { return res.send("location" + req.params.tagId); });
